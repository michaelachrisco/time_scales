...
# +TimeScales+
# Rspec specific module.
module TimeScales
  context do
    let(:_59_and_a_half) do
      Rational(119, 2)
    end
    ...
    describe Parts::YearOfScheme do
      ...
      describe '#&' do
        it 'Extracts the year component from the given time' do
          ...
          expect(subject & Time.new(2012, 12, 31, 23, 59, _59_and_a_half))
            .to eq(2012)
        end
      end
    end
    ...
    describe Parts::DayOfYear do
      ...
      describe '#&' do
        it 'Extracts the day-of-year value from the given time' do
          ...
          expect(subject & Time.new(2000, 12, 31, 23, 59, _59_and_a_half))
            .to eq(366)
        end
      end
    end
    ...
    describe Parts::HourOfDay do
      ...
      describe '#&' do
        it 'Extracts the hour component from the given time' do
          ...
          expect(subject & Time.new(2010,  5, 16, 13,  0,   0)).to eq(13)
          expect(subject & Time.new(2012, 12, 31, 23, 59, _59_and_a_half))
            .to eq(23)
        end
      end
